...
# Repository contents
## RShiny application
The `RShiny` folder contains the code to easily apply this Bayesian sample size estimation method to your own data. Some example datasets are included.
...
For full methods, please see the associated priprint/publication: Nagy et al., 2026. How much is enough? Optimising sampling frames for genomic surveillance of Escherichia coli and Klebsiella spp. bloodstream infections – a retrospective 
